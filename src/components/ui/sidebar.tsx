      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetTitle className="sr-only">MoneyFlow Navigation</SheetTitle>
            <SheetDescription className="sr-only">Access your financial dashboard, transactions, ledgers, and account settings.</SheetDescription>
